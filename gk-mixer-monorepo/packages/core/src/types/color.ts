// ============================================================
// GK Mixer Core Types
// Ported verbatim from GK-Mixer-miniwebtools-main/types.ts
// These types are pure data contracts - no UI, no environment APIs.
// The Swift port (apps/ios) will mirror these 1:1 as Codable structs.
// ============================================================
...
export interface PaintBrand {
  id: string;
  // Widen to include CMY pigment/solid pseudo-brands used by the mixing engine
  brand: 'Mr.Hobby' | 'Gaia' | 'Jumpwind' | 'Gunze' | 'CMY Pigment' | 'CMY Solid';
  code: string;
  name: string;
  hex: string;

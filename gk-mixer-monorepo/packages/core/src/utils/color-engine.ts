import type { CMYK, ColorData, ColorSpace, PaintBrand, RALColor, RGB } from '../types/color';
import { getColorDistance, hexToRgb, hsbToRgb, rgbToHex, rgbToHsb, rgbToLab } from './color-convert';
...
// `console` is a universal global (Node / web / RN / Hermes), but core's lib
// has no DOM types - declare the tiny subset used here.

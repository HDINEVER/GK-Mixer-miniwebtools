// ============================================================
// Color space conversion (sRGB / Display P3 / Adobe RGB)
// Ported verbatim from GK-Mixer-miniwebtools-main/utils/colorSpaceConverter.ts
// ============================================================

import type { ColorSpace, RGB } from '../types/color';
 ...
 * 获取色彩空间的显示名称
 */
export function getColorSpaceName(
  space: ColorSpace,
  lang: 'en' | 'zh' | 'ja' = 'zh',
): string {
  const names = {
 ...
 * 获取色彩空间描述
 */
export function getColorSpaceDescription(
  space: ColorSpace,
  lang: 'en' | 'zh' | 'ja' = 'zh',
): string {
  const descriptions = {
